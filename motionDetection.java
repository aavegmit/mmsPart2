...
public class motionDetection {
    ...
    public static void motionDetetcionAlgo() {
        int index = 0;
        int startHeightArray[] = {32, 32, 32, 32, 80, 80, 80, 80, 112, 112, 112, 112, 160, 160, 160, 160};
        int startWidthArray[] = {32, 96, 160, 224, 32, 96, 160, 224, 32, 96, 160, 224, 32, 96, 160, 224};
        try {
